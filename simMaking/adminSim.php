...
<head>
    ...
    <title>Beranda SIM Admin</title>
    <link rel="stylesheet" href="adminSim.css">
    ...
    <div class="main">
        <div class="header">
            <div class="leftH">
                ...
                <p>Pemrosesan Data Permohonan SIM</p>
            </div>
            <div class="rightH">
                <p>
                    Masuk<br>
        ...
        <div class="content">
            <div class="leftC">
                ...
                <div class="riwayat">
                    <h3 class="riwayatTitle">Riwayat Administrasi</h3>
                    <div class="cardHolder">
                        <div class="ditangani">
                            <p class="ditanganiTxt">Ditangani</p>
                        ...
                        <div class="antri">
                            <p class="antriTxt">Masuk Antrean</p>
                            <div class="cardRiwayat">
                                <div class="cardTxt">
                                    <h3>SIM B1</h3>
                                    <p>2930-0112-000372</p>
                        ...
                        <div class="gagal">
                            <p class="gagalTxt">Tidak Memadai</p>
                            <div class="cardRiwayat">
                                <div class="cardTxt">
                                    <h3>SIM C2</h3>
                                    <p>2930-0112-000372</p>
            ...
            <div class="rightC">
                <div class="currReq">
                    ...
                    <div class="currSim">
                        <div class="simTxt">
                            <h3>Maheswari Indira Yanti</h3>
                            <h2>SIM A</h2>
                            <p>3216061201010121</p>
                            <p>maheswariyanti123@gmail.com</p>
                            <br>
                            <p>Unggahan Foto KTP (Terverifikasi)</p>
                            <p>Lokasi Pengujian (Menunggu Konfirmasi)</p>
                        </div>
                        <img src="../assets/iconSimMobil.jpg" alt="">
                    </div>

                    <p class="konfirmasiTxt">Konfirmasi Pemberkasan</p>

                    <div class="creds">
                        <div class="credCard">
                            <img src="../assets/ktpImg.png" alt="">
                            <div class="credTxt">
                                <h3>KTP</h3>
                                <p>3216061201010121</p>
                                <p class="verify">verifikasi</p>
                            </div>
                        </div>
                        <div class="credCard">
                            <img src="../assets/ttdImg.png" alt="">
                            <div class="credTxt">
                        ...
                        <div class="btnGrp">
                            ...
                            <button class="setujui">Setujui</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="botR">
                    <div class="titleR">
                        <h1>Antrean Permohonan Masuk</h1>
                    </div>
                    <div class="cardHolderR">
                        <div class="cards">
                            <img src="../assets/iconSimMobil.jpg" alt="">
                            <div class="cardTxt">
                                <h3>Gayatri Ayu Kartika</h3>
                                <p>
                                3212812805770001<br>
                                ayu1977kartika@gmail.com
                                </p>
                                <p class="expand"><b><a href="#">Luaskan</a></b></p>
                            </div>
                        </div>
                        <div class="cards">
                            <img src="../assets/iconSimMobil.jpg" alt="">
                    ...
                    <a href="#" class="moreEntry"><p>Tampilkan Lebih Banyak Entri</p></a>
                </div>
            </div>
        </div>
    </div>
