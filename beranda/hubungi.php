...
<body>
    <div class="main">
        ...
        <div class="hero">
            <h1 class="n110">110</h1>
            <img src="../assets/heroHubungi.png" alt="">
            ...
            <div class="heroTxtBig">
                <div class="txtBigYellow"></div>
                <h1 class="txtHotline">HOTLINE</h1>
        ...
        <div class="content">
            <div class="contentTxt">
                <div class="yellowContent"></div>
                <p>
                    Dalam rangka lebih cepat memberikan pelayanan kepada masyarakat, Polri telah bekerjasama dengan PT
                    Telekomunikasi Indonesia (Telkom) untuk melaksanakan Layanan Contact Center 110. Kehadiran Layanan
                    Contact Center 110 POLRI ditujukan untuk memenuhi harapan dan kebutuhan masyarakat terhadap
                    terselenggaranya layanan keamanan publik. Dalam penyelenggaraan layanan contact center, telah
                    disiapkan
                    sebuah sistem aplikasi yang dapat memungkinkan pencatatan /perekaman setiap interaksi Polri &
                    masyarakat, sehingga dimungkinkan pengendalian response kebutuhan masyarakat terhadap Polri.
                    <br><br>
                    Sistem tersebut direncanakan akan membuka saluran via : telepon, sms, email, fax dan media sosial
                    yang
                    didukung oleh jaringan Telkom Group di Indonesia. Masyarakat yang nantinya melakukan panggilan ke
                    nomor
                    akses 110 akan langsung terhubung ke agen yang akan memberikan layanan berupa informasi, pelaporan
                    (kecelakaan, bencana, kerusuhan, dll) dan pengaduan (penghinaan, ancaman, tindak kekerasan dll).
                    Masyarakat bisa menggunakan layanan Contact Center 110 secara gratis. Namun demikian, Polri
                    menghimbau
                    agar layanan 110 ini tidak dibuat main-main, karena jika nantinya terjadi seperti itu, pihak Polri
                    tentu
            ...
            <div class="title">
                <div class="yellowKontak"></div>
                <h2>KONTAK RESMI POLRI</h2>
            </div>
            ...
            <div class="alamat">
                <div class="alamatTxt">
                    ...
                    <p class="alamate">
                        <b>Kepolisian Negara Republik Indonesia</b><br>
                        Alamat : Jl. Trunojoyo No.3, Jakarta Selatan<br>
