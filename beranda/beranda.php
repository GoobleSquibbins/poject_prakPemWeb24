    ...
    <div class="main">
        ...
        <div class="hero">
            ...
            <div class="heroText_big">
                <h1>MELINDUNGI MENGAYOMI <br>
                    DAN MELAYANI MASYARAKAT</h1>
            </div>
            <div class="gradient"></div>
            <div class="rect1"></div>
            <img class="rect" src="../assets/Rectangle 2.png" alt="">
            <img class="rect" src="../assets/Rectangle 3.png" alt="">
            <img class="rect" src="../assets/Rectangle 4.png" alt="">
            <img class="rect" src="../assets/Rectangle 5.png" alt="">
            <img class="rect" src="../assets/Rectangle 6.png" alt="">
        </div>

        <div class="quickOpt">
            <div class="quickOptItem">
                <p class="quickOptTxt">509</p>
                <img class="quickOptImg" src="../assets/Edit.png" alt="">
            </div>
            <div class="quickOptItem">
                <p class="quickOptTxt">509</p>
                <img class="quickOptImg" src="../assets/Book Open.png" alt="">
            </div>
            <div class="quickOptItem">
                <p class="quickOptTxt">509</p>
                <img class="quickOptImg" src="../assets/Archive.png" alt="">
            </div>
            <div class="quickOptItem">
                <p class="quickOptTxt">509</p>
                <img class="quickOptImg" src="../assets/Check square.png" alt="">
            </div>
        </div>

        <div class="ikuti_kami">
            <h1 class="ikutiTxt">Ikuti Kami</h1>
            <div class="ikutiMedsos">
                <p>Filter: </p>
                <div class="sosmedIkuti">
                    <svg xmlns="http://www.w3.org/2000/svg" class="sosmedIcon"
        ...
        <div class="post">
            ...
            <div class="post1">
                <div class="postHeader">
                    <img class="headerIcon" src="../assets/image 15.png" alt="">
                    <p>Kepolisian Republik Indonesia</p>
                    <p class="time">75m</p>
                </div>
                <div class="postMain">
                    <img class="postImg" src="../assets/image 16.png" alt="">
                    <p class="postTxt">
                        Polda Bali mengamankan debat terbuka ke-3 Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC
                        Nusadua, Rabu (20/11). Pengamanan dan pengawasan dilakukan mulai dari sterilisasi di dalam
                        lokasi debat maupun di luar lokasi, termasuk rute yang akan dilalui para Paslon dan
                        pendukungnya agar semua berjalan lancar dan aman. “Kami juga berharap kerja sama bagi para
                        simpatisan dan pendukung terutama yang hadir di lokasi debat, mari kita jaga situasi
                        Kamtibmas. Jangan terprovokasi maupun memprovokasi agar debat berjalan lancar dan damai,”
                        tutur Kabid Humas Polda Bali Kombes Pol. Jansen Avitus Panjaitan S.I.K., M.H.
                    </p>
                </div>
                <div class="postFooter">
                    <svg xmlns="http://www.w3.org/2000/svg" class="postFooterIcon"
                        viewBox="0 0 512 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                    ...
                    <p>39</p>
                    <svg xmlns="http://www.w3.org/2000/svg" class="postFooterIconRight"
                        viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path
                            d="M194.4 211.7a53.3 53.3 0 1 0 59.3 88.7 53.3 53.3 0 1 0 -59.3-88.7zm142.3-68.4c-5.2-5.2-11.5-9.3-18.4-12c-18.1-7.1-57.6-6.8-83.1-6.5c-4.1 0-7.9 .1-11.2 .1c-3.3 0-7.2 0-11.4-.1c-25.5-.3-64.8-.7-82.9 6.5c-6.9 2.7-13.1 6.8-18.4 12s-9.3 11.5-12 18.4c-7.1 18.1-6.7 57.7-6.5 83.2c0 4.1 .1 7.9 .1 11.1s0 7-.1 11.1c-.2 25.5-.6 65.1 6.5 83.2c2.7 6.9 6.8 13.1 12 18.4s11.5 9.3 18.4 12c18.1 7.1 57.6 6.8 83.1 6.5c4.1 0 7.9-.1 11.2-.1c3.3 0 7.2 0 11.4 .1c25.5 .3 64.8 .7 82.9-6.5c6.9-2.7 13.1-6.8 18.4-12s9.3-11.5 12-18.4c7.2-18 6.8-57.4 6.5-83c0-4.2-.1-8.1-.1-11.4s0-7.1 .1-11.4c.3-25.5 .7-64.9-6.5-83l0 0c-2.7-6.9-6.8-13.1-12-18.4zm-67.1 44.5A82 82 0 1 1 178.4 324.2a82 82 0 1 1 91.1-136.4zm29.2-1.3c-3.1-2.1-5.6-5.1-7.1-8.6s-1.8-7.3-1.1-11.1s2.6-7.1 5.2-9.8s6.1-4.5 9.8-5.2s7.6-.4 11.1 1.1s6.5 3.9 8.6 7s3.2 6.8 3.2 10.6c0 2.5-.5 5-1.4 7.3s-2.4 4.4-4.1 6.2s-3.9 3.2-6.2 4.2s-4.8 1.5-7.3 1.5l0 0c-3.8 0-7.5-1.1-10.6-3.2zM448 96c0-35.3-28.7-64-64-64H64C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96zM357 389c-18.7 18.7-41.4 24.6-67 25.9c-26.4 1.5-105.6 1.5-132 0c-25.6-1.3-48.3-7.2-67-25.9s-24.6-41.4-25.8-67c-1.5-26.4-1.5-105.6 0-132c1.3-25.6 7.1-48.3 25.8-67s41.5-24.6 67-25.8c26.4-1.5 105.6-1.5 132 0c25.6 1.3 48.3 7.1 67 25.8s24.6 41.4 25.8 67c1.5 26.3 1.5 105.4 0 131.9c-1.3 25.6-7.1 48.3-25.8 67z" />
                    </svg>
            ...
            <div class="post2">
                ...
                <div class="postMain">
                    <img class="postImg" src="../assets/image 19.png" alt="">
                    <p class="postTxt">
                        Polda Bali mengamankan debat terbuka ke-3 Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC
                        Nusadua, Rabu (20/11). Pengamanan dan pengawasan dilakukan mulai dari sterilisasi di dalam
                        lokasi debat maupun di luar lokasi, termasuk rute yang akan dilalui para Paslon dan
            ...
            <div class="post3">
                ...
                <div class="postMain">
                    <img class="postImg" src="../assets/image 22.png" alt="">
                    <p class="postTxt">
                        Polda Bali mengamankan debat terbuka ke-3 Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC
                        Nusadua, Rabu (20/11). Pengamanan dan pengawasan dilakukan mulai dari sterilisasi di dalam
                        lokasi debat maupun di luar lokasi, termasuk rute yang akan dilalui para Paslon dan
            ...
            <div class="post5">
                ...
                <div class="postMain">
                    <img class="postImg" src="../assets/image 21.png" alt="">
                    <p class="postTxt">
                        Polda Bali mengamankan debat terbuka ke-3 Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC
                        Nusadua, Rabu (20/11). Pengamanan dan pengawasan dilakukan mulai dari sterilisasi di dalam
                        lokasi debat maupun di luar lokasi, termasuk rute yang akan dilalui para Paslon dan
            ...
            <div class="post6">
                ...
                <div class="postMain">
                    ...
                    <p class="postTxt">
                        Polda Bali mengamankan debat terbuka ke-3 Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC
                        Nusadua, Rabu (20/11). Pengamanan dan pengawasan dilakukan mulai dari sterilisasi di dalam
                        lokasi debat maupun di luar lokasi, termasuk rute yang akan dilalui para Paslon dan pendukungnya
                        agar semua berjalan lancar dan aman. “Kami juga berharap kerja sama bagi para simpatisan dan
                        pendukung terutama yang hadir di lokasi debat, mari kita jaga situasi Kamtibmas. Jangan
                        terprovokasi maupun memprovokasi agar debat berjalan lancar dan damai,” tutur Kabid Humas Polda
                        Bali Kombes Pol. Jansen Avitus Panjaitan S.I.K., M.H. Polda Bali mengamankan debat terbuka ke-3
                        Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC Nusadua, Rabu (20/11). Pengamanan dan
                        pengawasan dilakukan mulai dari sterilisasi di dalam lokasi debat maupun di luar lokasi,
                        termasuk rute yang akan dilalui para Paslon dan pendukungnya agar semua berjalan lancar dan
                        aman. “Kami juga berharap kerja sama bagi para simpatisan dan pendukung terutama yang hadir di
                        lokasi debat, mari kita jaga situasi Kamtibmas. Jangan terprovokasi maupun memprovokasi agar
                        debat berjalan lancar dan damai,” tutur Kabid Humas Polda Bali Kombes Pol. Jansen Avitus
                        Panjaitan S.I.K., M.H.
                    </p>
                </div>
                <div class="postFooter">
            ...
            <div class="post7">
                ...
                <div class="postMain">
                    <img class="postImg" src="../assets/image 20.png" alt="">
                    <p class="postTxt">
                        Polda Bali mengamankan debat terbuka ke-3 Paslon Cagub-Cawagub Bali 2024, bertempat di BNDCC
                        Nusadua, Rabu (20/11). Pengamanan dan pengawasan dilakukan mulai dari sterilisasi di dalam
                        lokasi debat maupun di luar lokasi, termasuk rute yang akan dilalui para Paslon dan
